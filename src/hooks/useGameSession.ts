...
import { MATCHING_PAIRS, MONSTER_ROUNDS, PITCH_ROUNDS, WHACK_ROUNDS } from '../data/gameContent';
...
const FALLBACK_SESSIONS: Record<GameId, GameSession> = {
  ...
  whack: { gameId: 'whack', rounds: WHACK_ROUNDS },
};
...
export function useGameSession(gameId: 'whack'): { session: WhackGameSession; error: string | null };
